# Fork
This is a fork to try and understand how Position Control is working properly :) 

of the universal_robot

# Testing and bringup my example:
roslaunch ur_gazebo ur5.launch 


roslaunch demo_moveit_config demo_playing_execution.launch 
